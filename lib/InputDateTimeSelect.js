...
class InputDateTime extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.value.startDate !== this.props.value.startDate || nextProps.value.endDate !== this.props.value.endDate) {
      this.setState({
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <DateRangePicker
            startDate={moment(this.props.getValue().startDate, 'DD/MM/YYYY hh:mm:ss a')}
            endDate={moment(this.props.getValue().endDate, 'DD/MM/YYYY hh:mm:ss a')}
...
InputDateTime.defaultProps = {
  ...
  onEvent: () => {},
  value: {
    startDate: moment('01/01/1900'),
    endDate: moment('01/01/2100'),
  },
